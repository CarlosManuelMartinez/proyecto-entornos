...
import com.example.instalacionnueva.data.CompetitionType;
...
public class FilesIO {
    ...
    public static ObservableList<Competition> ObsCompListFromTxt(String fileName,
                                                                 String symbol){
        ObservableList<Competition> competitionsObser =
        ...
        try{
            ...
            String line = inputFile.readLine();
            while (line != null){
                competitionsObser.add(LineParseCompetition(line,symbol));
                line = inputFile.readLine();
            }
            return competitionsObser;
        }
        catch (IOException fileError){

            System.out.println("CompetitionListFromTxt");
            System.err.println("Error reading fileName");
            return competitionsObser;
        }

    }
    public static List<Competition> CompetitionListFromTxt(String fileName,
                                                           String symbol){
        ...
        try{
            ...
            String line = inputFile.readLine();
            while (line != null){
                competitions.add(LineParseCompetition(line,symbol));
                line = inputFile.readLine();
            }
            return competitions;
        }
